			...
			<form action="" method="GET">
				...
				<div class="form-group">
					...
					<select id="estado" name="filtros[estado]" class="form-control">
						<option></option>
						<option value="3" <?php echo ($filtros['estado']=='3')?'selected="selected"':''; ?>>Ruim</option>
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<img src="<?php echo BASE_URL; ?>assets/images/img.png<?php echo $anuncio['url']; ?>" height="50" border="0" />
							<?php else: ?>
							<img src="<?php echo BASE_URL; ?>assets/images/img.png" height="50" border="0" />
							<?php endif; ?>
						</td>
						<td>
